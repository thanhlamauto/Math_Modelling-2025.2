...
This distance is then used to determine the infection probability. In the numerical implementation, percolation is detected when the infection front reaches a system-scale distance from the initial infected individual, following the same practical convention as the comparison code in \texttt{math\_modeling/}.
